 ...
 * helper methods.
 */
public class Noti_addsix extends IntentService {
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, Noti_addsix.class);
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String date1 = intent.getStringExtra("timeinsix");
        ...
        try {
            while (running) {
                if (isMyServiceRunning(Noti_addsix.class)) {
